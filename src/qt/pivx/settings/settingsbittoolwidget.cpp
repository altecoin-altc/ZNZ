...
SettingsBitToolWidget::SettingsBitToolWidget(ZENZOGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsBitToolWidget)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("ZENZO address"));
