    ...
    ui(new Ui::CoinControlPivWidget)
{
    ...
    ui->labelTitle->setText("Select ZNZ Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("ZNZ");
    ...
    ui->labelValueAfter->setText("0.00 ZNZ");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 ZNZ");
    ui->labelValueFee->setText("0.00 ZNZ");
