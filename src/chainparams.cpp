...
public:
    CMainParams()
    {
        ...
        // validation by-pass
        consensus.nPivxBadBlockTime = 1538501313;    // Skip nBit validation of Block 259201 per PR #915
        consensus.nPivxBadBlockBits = 0x1d4c8620;    // Skip nBit validation of Block 259201 per PR #915
